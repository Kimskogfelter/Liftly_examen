          ...
          <div className="flex items-center gap-2 md:gap-3 mt-4 pt-3 border-t border-gray-100/60">
            ...
            {targetUser.socialLinks.instagram && (
              <a
                ...
                className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 md:px-3.5 md:py-1.5 rounded-full bg-pink-50 text-pink-600 border border-pink-100 hover:bg-pink-100 transition-all shrink-0"
              >
            ...
            {targetUser.socialLinks.tiktok && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 md:px-3.5 md:py-1.5 rounded-full bg-gray-100 text-gray-900 border border-gray-200 hover:bg-gray-200 transition-all shrink-0"
              >
                ...
                <span className="hidden md:inline">@{targetUser.socialLinks.tiktok}</span>
              </a>
            )}
            ...
            {targetUser.socialLinks.youtube && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1.5 md:px-3.5 md:py-1.5 rounded-full bg-red-50 text-red-600 border border-red-100 hover:bg-red-100 transition-all shrink-0"
              >
                ...
                <span className="hidden md:inline">@{targetUser.socialLinks.youtube}</span>
              </a>
            )}
          </div>
        )}
